...
export default function Login() {
  return (
    <main className="w-[500px] rounded bg-white p-8 shadow-lg shadow-black/20">
      <header className="mb-6 flex w-full flex-col items-center justify-center">
        ...
        <p className="mt-2 text-center text-sm font-medium text-black">
          Bem vindo ao pokemon shop, Faça login abaixo
        </p>
      </header>
      ...
      <footer className="mt-6 text-center">
        <Link href={'/register'} className="text-sm font-bold text-black ">
          Se você não possui conta,{' '}
          <span className="text-yellow-500">Crie uma agora</span>
        </Link>
      </footer>
    </main>
  )
