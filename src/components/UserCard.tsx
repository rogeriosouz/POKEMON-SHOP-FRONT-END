...
export function UserCard() {
  ...
  return (
    <>
      {isAuthenticated ? (
        <Popover.Root>
          <Popover.Trigger className="h-10 w-10 overflow-hidden rounded-full bg-red-500" />
          <Popover.Portal>
            <Popover.Content
              align="end"
              className="z-[99999999] w-[250px] overflow-hidden rounded bg-zinc-100"
            >
              <div className="w-full p-2">
                <p className="mb-1 text-sm font-bold">{user?.name}</p>
                <h2 className="font-bold text-red-500">P${user?.coins}</h2>
              </div>

              <div className="flex w-full flex-col">
                <Link
                  href={'/users/mypokemons'}
                  className="flex w-full items-center gap-2 bg-zinc-100 px-3 py-2 transition-colors hover:bg-red-500 hover:text-zinc-50"
                >
                  <svg
                  ...
                  <p className="text-sm font-medium">Meus pokemons</p>
                </Link>
              </div>
              ...
              <Popover.Arrow className="h-3 w-4 fill-zinc-100" />
            </Popover.Content>
          </Popover.Portal>
        </Popover.Root>
      ) : null}
