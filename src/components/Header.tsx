...
export function Header() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-[9999] h-20 border-b border-transparent bg-zinc-800 transition-colors duration-300">
      <div className="mx-auto flex h-full max-w-[1450px] items-center justify-between">
        <Link href={'/'} className="flex cursor-pointer items-center gap-2">
          ...
          <h1 className="text-sm font-black text-zinc-50">
            POKEMON<span className="text-red-500"> SHOP</span>
          </h1>
        </Link>

        <div className="flex items-center gap-10">
          <nav className="flex items-center gap-10">
            <LinkNavigation href="/" title="Pokemons" />

            {isAuthenticated && (
              <LinkNavigation href="/users/mypokemons" title="Meus pokemons" />
            )}
          </nav>
          ...
          <div
            className={clsx('items-center gap-2', {
              hidden: isAuthenticated,
              flex: !isAuthenticated,
            })}
          >
            <Link
              href={'/login'}
              className=" group flex items-center  gap-1 rounded border-[2px] border-red-500 px-5 py-2  text-sm font-bold  text-red-500 transition-colors hover:text-red-500"
            >
              <User
                className="h-5 w-5  text-red-500 transition-colors group-hover:text-red-500"
                weight="fill"
              />
              Login
            </Link>
            ...
            <Link
              href={'/register'}
              className=" group flex items-center  gap-1 rounded bg-red-500 px-5 py-[9px] text-sm  font-bold text-zinc-200  transition-colors"
            >
              Criar conta
            </Link>
          </div>
